        ...
        <div class="container section ">
            ...
            <div class="matiere_container grid">
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 3 ;?>" class="matier_link">تربية
                            اسلامية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 10 ;?>" class="matier_link">اللغة
                            العربية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 71 ;?>"
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 78 ;?>" class="matier_link">العلوم</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 85 ;?>"
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 92 ;?>" class="matier_link">التربية
                            البدنية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 99 ;?>" class="matier_link">التربية
                            المدنية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 106;?>" class="matier_link">الفيزياء</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 113;?>" class="matier_link">التاريخ و
                            الجغرافيا</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 120;?>" class="matier_link">الفرنيسة</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 127;?>"
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 134;?>" class="matier_link">علوم
                            الكمبيوتر</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 141;?>" class="matier_link">التربية
                            الموسيفية</a>
                    </h3>
                </div>
            </div>
