        ...
        <div class="container section ">
            ...
            <div class="matiere_container grid">
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 6 ;?>" class="matier_link">تربية
                            اسلامية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 13 ;?>" class="matier_link">اللغة
                            العربية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 74 ;?>" class="matier_link">الرياضيات</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 81 ;?>" class="matier_link">العلوم</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 88 ;?>"
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 95 ;?>" class="matier_link">التربية
                            البدنية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 102 ;?>" class="matier_link">التربية
                            المدنية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 109;?>" class="matier_link">الفيزياء</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 116;?>" class="matier_link">التاريخ و
                            الجغرافيا</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 123;?>" class="matier_link">الفرنيسة</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 130;?>"
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 137;?>" class="matier_link">علوم
                            الكمبيوتر</a>
                    </h3>
                </div>
            </div>
