        ...
        <div class="container section ">
            ...
            <div class="matiere_container grid">
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 5 ;?>" class="matier_link">تربية
                            اسلامية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 12 ;?>" class="matier_link">اللغة
                            العربية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 73 ;?>" class="matier_link">الرياضيات</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 80 ;?>" class="matier_link">العلوم</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 87 ;?>"
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 94 ;?>" class="matier_link">التربية
                            البدنية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 101 ;?>" class="matier_link">التربية
                            المدنية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 108;?>" class="matier_link">الفيزياء</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 115;?>" class="matier_link">التاريخ و
                            الجغرافيا</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 122;?>" class="matier_link">الفرنيسة</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 129;?>"
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 136;?>" class="matier_link">علوم
                            الكمبيوتر</a>
                    </h3>
                </div>
            </div>
