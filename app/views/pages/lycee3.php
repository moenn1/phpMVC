        ...
        <div class="container section ">
            ...
            <div class="matiere_container grid">
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 7 ;?>" class="matier_link">تربية
                            اسلامية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 14 ;?>" class="matier_link">اللغة
                            العربية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 75 ;?>"
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 82 ;?>" class="matier_link">العلوم</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 89 ;?>"
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 96 ;?>" class="matier_link">التربية
                            البدنية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 103 ;?>" class="matier_link">التربية
                            المدنية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 110;?>" class="matier_link">الفيزياء</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 117;?>" class="matier_link">التاريخ و
                            الجغرافيا</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 124;?>" class="matier_link">الفرنيسة</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 131;?>"
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 138;?>" class="matier_link">علوم
                            الكمبيوتر</a>
                    </h3>
                </div>
            </div>
