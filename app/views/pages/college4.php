        ...
        <div class="container section ">
            ...
            <div class="matiere_container grid">
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 4 ;?>" class="matier_link">تربية
                            اسلامية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 11 ;?>" class="matier_link">اللغة
                            العربية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 72 ;?>"
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 79 ;?>" class="matier_link">العلوم</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 86 ;?>"
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 93 ;?>" class="matier_link">التربية
                            البدنية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 100 ;?>" class="matier_link">التربية
                            المدنية</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 107;?>" class="matier_link">الفيزياء</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 114;?>" class="matier_link">التاريخ و
                            الجغرافيا</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 121;?>" class="matier_link">الفرنيسة</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 128;?>"
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 135;?>" class="matier_link">علوم
                            الكمبيوتر</a>
                    </h3>
                </div>
                ...
                <div class="matiere_card">
                    ...
                    <h3 class="h3">
                        <a href="<?php echo URLROOT ;?>/pages/lesson/<?php echo 142;?>" class="matier_link">التربية
                            الموسيفية</a>
                    </h3>
                </div>
            </div>
